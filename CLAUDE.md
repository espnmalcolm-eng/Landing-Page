...
1. **Hero** — animated headline ("filtered" struck through in gold, "in" gold italic), phone-number waitlist form (SMS consent copy, `type="tel"`, validates 10–15 digits).
2. **01 — Why we exist** — manifesto on ATS/AI screeners and ghost jobs as "the villain," pullquote, two pillar cards.
...
6. **Final waitlist** — second phone form, scarcity framing ("the room is filling up").
